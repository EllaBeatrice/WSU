...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index.php" class="logo">
      ...
      <span class="logo-mini"><b>WSU</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>World Shine USA</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <h5><b><?php echo htmlspecialchars($_SESSION["username"]); ?></b></h5>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header"><b>MANAGE</b></li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../pages/charts/chartjs.php"><i class="fa fa-plus-square-o"></i> Add Page</a></li>
            <li><a href="../pages/charts/chartjs.php"><i class="fa fa-pencil-square-o"></i> Edit Page</a></li>
            <li><a href="../pages/charts/morris.php"><i class="fa fa-refresh"></i> Update Page</a></li>
            <li><a href="pages/charts/flot.php"><i class="fa fa-trash-o"></i>Delete Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="">
        ...
        <li class="header"><b>CONFIGURE</b></li>
        <li class="treeview">
          <a href="">
            <i class="fa fa-share-alt"></i> <span>Sharing</span>
          </a>
        </li>
        <li class="treeview">
          <a href="">
        ...
        <li><a href="documentation/welcome.php"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Title: Welcome to World Shine Ministries</b></h4>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: About</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Ministry Activities</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Board of directors</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Africa</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: America</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Mission Trips</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Accomplishments</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Partners</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Title: Donate</b></h4>
              </div>
              <div class="modal-body">
                <p>One fine body&hellip;</p>
              </div>
  ...
  <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2018 <a href="../../index.php">World Shine USA</a>.</strong> All rights
    reserved.
  </footer>
